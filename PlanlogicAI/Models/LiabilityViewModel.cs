...
{
    public partial class LiabilityViewModel
    {
    ...
    public class LiabilityDrawdowns
    {
        public LiabilityViewModel liability { get; set; }
        public LiabilityDetailsViewModel[] liabilitydd { get; set; }
    }
